...
### 1
 ...
 ![DIAGRAMA1](/docs/figs/Camara_dañada.jfif)
 ### CÁMARA DAÑADA

 ![DIAGRAMA1](/docs/figs/Camara_funcional.jfif)
### CÁMARA FUNCIONAL

    PRECAUCIÓN 2:
    ¡ASEGURARSE DE QUE LA CONEXIÓN PULLDOWN SE REALICE CORRECTAMENTE, ES DECIR QUE SE ENCUENTRE CONECTADA DE FORMA CORRECTA ENTRE SIOC Y SIOD A LAS RESISTENCIAS Y ENTRADAS DEL ARDUINO CORRESPONDIENTES!
